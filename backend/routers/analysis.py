...
async def trigger_analysis(
    ...
    if existing:
        ...
        existing["time_complexity"] = existing.get("timeComplexity")
        existing["space_complexity"] = existing.get("spaceComplexity")
        existing["approach"] = existing.get("approach")
        existing["approach_explanation"] = existing.get("approachExplanation")
        existing["efficiency_score"] = existing.get("efficiencyScore")
        existing["code_quality_score"] = existing.get("codeQualityScore")
        existing["overall_score"] = existing.get("overallScore")
        existing["optimized_solution_hint"] = existing.get("optimizedSolutionHint")
    ...
    if created:
        ...
        created["time_complexity"] = created.get("timeComplexity")
        created["space_complexity"] = created.get("spaceComplexity")
        created["approach"] = created.get("approach")
        created["approach_explanation"] = created.get("approachExplanation")
        created["efficiency_score"] = created.get("efficiencyScore")
        created["code_quality_score"] = created.get("codeQualityScore")
        created["overall_score"] = created.get("overallScore")
        created["optimized_solution_hint"] = created.get("optimizedSolutionHint")
