    ...
    <div className="h-full flex flex-col bg-background rounded-xl border-2 border-black overflow-hidden shadow-[3px_3px_0px_0px_#000]">
      ...
      <div className="flex items-center justify-between px-4.5 py-3 bg-secondary-background border-b-2 border-black flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-black uppercase tracking-wider text-foreground ml-2 flex items-center gap-2">
            <Sparkles className="w-3.5 h-3.5 fill-current text-[#d67aff]" />
            ai evaluation
          </span>
        </div>
        <span className="font-mono text-[10px] font-bold bg-background border border-black text-foreground px-2 py-0.5 rounded">
          v2.0
        </span>
      </div>

      {/* Terminal Body */}
      <div className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin animate-fade">
        {loading ? (
          <div className="space-y-4 animate-pulse select-none">
            ...
            <div className="grid grid-cols-3 gap-4 pt-2">
              <div className="h-16 bg-zinc-200 dark:bg-zinc-800 rounded-xl border-2 border-black" />
              <div className="h-16 bg-zinc-200 dark:bg-zinc-800 rounded-xl border-2 border-black" />
              <div className="h-16 bg-zinc-200 dark:bg-zinc-800 rounded-xl border-2 border-black" />
            </div>
          </div>
